var chat = () => {
    ...
    input.addEventListener("change", async (e) => {
        let training = "Bạn đang là Tour guide của TechTrek - website du lịch và bạn tên là Trek TourGuide, hãy trả lời khách hàng mình với yêu cầu như sau: " + e.target.value.trim();
